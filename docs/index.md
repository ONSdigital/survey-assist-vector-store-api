...
- a vector-search API backed by persisted embedding artifacts for SIC and SOC search
...
- **Vector Search**: Similarity-based SIC and SOC retrieval from built embedding artifacts
...
- **Artifact Build Scripts**: Local commands for creating vector-search and SAYT artifacts
...
- Vector-search Swagger UI: `http://localhost:8088/docs`
- Vector-search ReDoc: `http://localhost:8088/redoc`
