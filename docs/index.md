...
- **Taxonomy-agnostic Local Workflow**: The same build and run commands can target SIC, SOC, or future knowledgebases by changing source files, artifact directories, and ports
...
see the [Guide](guide.md). The guide also includes examples of building and
running separate SIC and SOC artifacts side by side with the same commands.
